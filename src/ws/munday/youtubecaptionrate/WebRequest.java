...
public class WebRequest {
	...
	public String PostFileWithBasicAuthorization(String uri, String filename, String Username, String Password) throws ClientProtocolException, IOException, URISyntaxException{
		_post = new HttpPost(uri);
